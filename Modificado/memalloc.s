...
memory_alloc:
    ...
    verifica_endereco:
        movq 8(%rax), %r10          # r10 = tamanho do bloco
        cmpq %r13, %r10             
        jle bloco_ocupado           # if( r10 <= r13 )
        movq %r10, %r13
        movq %rax, %rdx
        jmp bloco_ocupado
    ...
    worst_fit:
        ...
        je arruma_ponteiro_heap     # if ( current_brk == original_brk ) ==> ja sei que preciso atualizar ponteiro do brk
